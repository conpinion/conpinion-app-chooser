module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    copy: {
      options: {
        noProcess: ['./conpinion-logo.png']
      },
      logo: {
        src: './conpinion-logo.png',
        dest: 'build/conpinion-logo.png',
      }
    },
    ...
    htmlbuild: {
      dist: {
        ...
        options: {
          scripts: {
            'conpinion-app-chooser': ['build/conpinion-app-chooser.js']
          },
          styles: {
            'conpinion-app-chooser': ['build/conpinion-app-chooser.css']
          },
          data: {
  ...
  grunt.registerTask('build', 'Compile all assets and create the distribution files',
      ['less', 'coffeelint', 'coffee', 'htmlbuild', 'replace', 'copy:logo']);
